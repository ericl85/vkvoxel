...
namespace VkVoxel {
    ...
    void VkRenderer::cleanup() {
        ...
        _manager->cleanup();
        vkDestroySurfaceKHR(_manager->getInstance(), surface, nullptr);
        _manager->cleanupInstance();
    }
    ...
    void VkRenderer::setWindow(GLFWwindow* window) {
        this->window = window;
    }
    ...
    void VkRenderer::render() {
        ...
        VkQueue graphicsQueue = _manager->getGraphicsQueue();
        ...
        VkQueue presentQueue = _manager->getPresentQueue();
...
#pragma region VULKAN FUNCTIONS
    ...
    void VkRenderer::createSurface(VkInstance instance) {
        if (window == nullptr) {
            throw std::runtime_error("There is no window pointer. Call setWindow before creating a surface.");
        }
    ...
    void VkRenderer::createCommandBuffers() {
        ...
        allocInfo.commandPool = _manager->getCommandPool();
...
#pragma endregion VULKAN FUNCTIONS
...
#pragma region UTILITY FUNCTIONS
    ...
    void VkRenderer::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VmaMemoryUsage memoryUsage, VkImage& image, VmaAllocation& imageAllocation) {
